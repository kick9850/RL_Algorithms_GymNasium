...
class Agent():
    ...
    def __init__(self,
        ...
        self.hiedden_size = hiedden_size
        self.tau =tau
    ...
    def step(self, c_k):
        ...
        experiences = self.memory.sample(self.buffer_size, c_k)
...
def main():
    ...
    parser.add_argument("-bs", "--buffer_size", type=int, default=int(1e6),
        ...
        for t in range(1, int(n_interactions) + 1):
            ...
            for i in range(max_ep_len):
                ...
                if done or i == max_ep_len - 1:
                    ...
                    if episodes % args.print_every == 0:
                        print('\rEpisode {}  Reward: {:.2f}  Average100 Score: {:.2f}'.format(episodes, score,
